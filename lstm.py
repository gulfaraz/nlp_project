...
class LSTM(nn.Module):
	...
	def forward(self, text_input, image_input, last_words):
		...
		last_out = torch.gather(lstm_out, 1, last_words.view(-1,1,1).expand(self.batch_size, 1, self.hidden_size) - 1)
...
model = LSTM(nwords, embedding_size, image_feature_size, output_vector_size, hidden_size, batch_size)
print (model)
