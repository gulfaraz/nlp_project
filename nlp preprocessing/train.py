...
class Train():
    def __init__(self, difficulty):
        ...
        self.model_name = "nlp_preprocessing_" + self.difficulty
    ...
    def __call__(self, number_of_iterations = 2, learning_rate = 0.005, embedding_size = 300):
        print("Starting 'Image Retrieval' in 'NLP Preprocessing' mode with '" + self.difficulty + "' data")
        ...
        self.model = NaiveCBOW(self.nwords, self.embedding_size, self.image_feature_size, self.output_vector_size)
    ...
    def minibatch(self, data, batch_size = 5000):
    ...
    def magic(self):
        for ITER in range(self.number_of_iterations):
            ...
            for batch_iteration, batch in enumerate(self.minibatch(self.train)):
